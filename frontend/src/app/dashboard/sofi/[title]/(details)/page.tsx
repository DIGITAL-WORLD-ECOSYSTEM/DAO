 ...
 * Role: Dashboard SoFi Details (Admin View)
 * Version: 1.4.3 - Fix: Prerender stability & Runtime optimization
 */

import { _mock } from 'src/_mock';

import { SoFiDetailsView } from 'src/sections/sofi/view';
...
export default async function SoFiDetailsPage({ params }: Props) {
  ...
  return <SoFiDetailsView post={sanitizedSoFi} />;
}