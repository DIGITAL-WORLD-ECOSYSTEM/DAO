...
export type AuthContextValue = {
  ...
  signIn: (email: string, password: string, otpCode?: string) => Promise<{ mfaRequired?: boolean; success?: boolean }>;
  signUp: (data: any, mnemonic: string) => Promise<void>;
  reclaimIdentity: (username: string, mnemonic: string, newPassword?: string) => Promise<void>;
