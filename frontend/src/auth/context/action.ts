...
/** **************************************
 * Sign in (DEPRECATED - Use useAuthContext)
 *************************************** */
export const signInWithPassword = async ({ email, password }: SignInParams): Promise<void> => {
  console.warn('⚠️ signInWithPassword is deprecated. Use signIn from useAuthContext instead.');
  try {
...
/** **************************************
 * Sign up (DEPRECATED - Use useAuthContext)
 *************************************** */
export const signUp = async ({
  ...
  console.warn('⚠️ signUp from action.ts is deprecated. Use signUp from useAuthContext instead.');
  const params = {
    email,
    password,
    firstName,
