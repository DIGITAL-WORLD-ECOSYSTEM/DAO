...
export const DashboardTemplate = (props: DashboardProps) => html`
  ...
  <html lang="en" itemscope itemtype="http://schema.org/WebPage">
    <head>
      ...
      <meta
        name="description"
        content="Official dashboard for ASPPIBRA DAO. Monitor real-time $ASPPBR token price, agricultural asset treasury, governance voting, and decentralized network telemetry on BSC."
      />
      <meta
        name="keywords"
        content="ASPPIBRA, DAO, RWA, Real World Assets, Tokenization, Agro DeFi, BSC, Governance, $ASPPBR, Web3, Agriculture Blockchain, Brazil Crypto"
      />
      ...
      <meta
        ...
        content="⚡ Live Market: $ASPPBR Token Price, Liquidity & Governance metrics. The first decentralized protocol bridging Brazilian Agriculture with Web3."
      />
      ...
      <meta
        ...
        content="Track ASPPIBRA's Real-World Asset treasury and network health in real-time. Governance for the future of agriculture."
      />
          ...
          >
            ...
            >
              <div style="display: flex; flex-direction: column; align-items: flex-start;">
                <div
                  style="display: inline-flex; align-items: center; gap: 8px; margin-bottom: 0.5rem;"
                >
                  <span
                    class="live-dot"
                    style="background: var(--success-color); box-shadow: 0 0 10px var(--success-color);"
                  ></span>
                  <span
                ...
                <h2 style="font-size: 2rem; margin: 0; line-height: 1.1;">
                  ASPPIBRA <span style="color: var(--text-highlight);">$ASPPBR</span>
                </h2>
            ...
            <div
              style="position: absolute; bottom: 0; left: 0; right: 0; height: 140px; width: 100%; pointer-events: none;"
            >
              <svg
                width="100%"
                height="100%"
          ...
          <div class="tech-dashboard">
            <div class="col-system">
              <div class="governance-card glass-panel">
                ...
                <h2
                  style="margin: 0; font-size: 1.4rem; font-weight: 700; color: var(--text-highlight);"
                >
                  Governance System
                </h2>
                <p style="color: var(--text-muted); margin-top: 0.5rem; font-size: 0.9rem;">
                  API Backend & DAO Services
                </p>
                <div class="status-badge"><span class="dot"></span> Operational</div>
                <div class="sys-details">
                  <div class="sys-row">
                    <span>Version</span> <span class="sys-val">${props.version}</span>
                  </div>
                  <div class="sys-row">
                    <span>Service</span> <span class="sys-val">${props.service}</span>
                  </div>
                  <div class="sys-row"><span>Region</span> <span class="sys-val">Global</span></div>
                  <div class="sys-row">
                    <span>Cache Ratio</span>
                    <span class="sys-val" id="lbl-cache-ratio">${props.cacheRatio}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-infra">
              <div class="db-metrics-row">
                <div class="metric-card glass-panel">
                  ...
                  <div class="metric-bar">
                    <div class="bar-fill cyan" id="bar-reads" style="width: 0%;"></div>
                  </div>
                </div>
                ...
                <div class="metric-card glass-panel">
                  ...
                  <div class="metric-bar">
                    <div class="bar-fill purple" id="bar-writes" style="width: 0%;"></div>
                  </div>
                </div>
                ...
                <div class="metric-card glass-panel">
                  ...
                  <div class="metric-bar">
                    <div class="bar-fill purple" id="bar-workload" style="width: 0%;"></div>
                  </div>
                </div>
              </div>
              ...
              <div class="countries-card glass-panel">
                <div class="card-header">
                  <h4
                    style="margin:0; font-weight:600; color: var(--text-highlight); display:flex; align-items:center; gap:8px;"
                  >
                    🌍 Traffic Origin
                  </h4>
                ...
                <div class="country-list-container">
                  <ul class="country-list" id="list-countries">
                    <li class="country-item">
                      <span class="loading">Scanning global nodes...</span>
                    </li>
                  </ul>
                </div>
              </div>
